...
namespace backlog.api.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreateTimeStamp", "Login", "Name", "Password" },
                values: new object[] { -1, new DateTime(2021, 11, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "root", "root", "*" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProjects_UserRoleId",
                table: "UserProjects",
                column: "UserRoleId");
        }
